...
import os
import sys
sys.path.insert(0, os.path.abspath('./pyresid/'))


# -- Project information -----------------------------------------------------

project = 'pyresid'
copyright = '2018, Rob Firth'
author = 'Rob Firth'
...
latex_documents = [
    (master_doc, 'pyresid.tex', 'pyresid Documentation',
     'Rob Firth', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyresid', 'pyresid Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyresid', 'pyresid Documentation',
     author, 'pyresid', 'One line description of project.',
     'Miscellaneous'),
]
